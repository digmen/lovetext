    ...
    <div className="bg-black">
      <ScrollContainer>
        <ScrollPage page={0}>
          <Animator animation={batch(Fade(), Sticky(), MoveOut(0, -200))}>
            <div className="flex flex-col justify-center items-center gap-3">
              ...
              <img src={arrowDown} alt="arrow" className="w-[40px] h-[40px]" />
            </div>
          </Animator>
        </ScrollPage>
        <ScrollPage page={1}>
        ...
        <ScrollPage page={14}>
          ...
          <div>
            <div className="flex">
              <Animator animation={batch(MoveIn(0, 0), MoveOut(0, -1000))}>
                <img src={heartIcon} alt="heart" />
              </Animator>
              <Animator animation={batch(MoveIn(0, 0), MoveOut(0, -1000))}>
                <img src={heartIcon} alt="heart" />
        ...
        <ScrollPage page={16}>
          <Animator
            animation={batch(Fade(), Sticky(), MoveIn(0, -300), MoveOut(0, 0))}
          >
            <span className="text-white text-2xl flex items-center gap-1">
              Я люблю тебя <img src={heartIcon} alt="heart" />
            </span>
